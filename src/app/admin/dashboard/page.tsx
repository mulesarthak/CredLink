      ...
      <div className="container mx-auto px-6 lg:px-8 py-10">
        ...
        <div className="card mb-12 p-8">
          <div className="card-header mb-6">
            <h3 className="card-title text-xl">Your Permissions</h3>
            <p className="card-description mt-1">Access rights granted to your account</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {(admin.role === 'SUPER_ADMIN' || admin.permissions.includes('MANAGE_ADMINS')) && (
            <div 
              ...
              className="card p-6 hover:shadow-xl transition-all cursor-pointer hover:-translate-y-1"
            >
              <div className="flex items-center gap-4">
          ...
          <div className="card p-6 hover:shadow-xl transition-all cursor-pointer hover:-translate-y-1">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-background-light-green rounded-xl flex items-center justify-center shadow-sm">

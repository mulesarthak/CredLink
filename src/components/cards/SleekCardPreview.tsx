  ...
  const renderItem = (title: string, subtitle?: string) => (
    <div style={{ 
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div>
          <div style={{ fontWeight: 700, color: '#ffffff' }}>{title}</div>
          {subtitle && <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)' }}>{subtitle}</div>}
        </div>
      </div>
    </div>
  );
    ...
    <div style={{ position: 'relative', width: '100%', display: 'flex', justifyContent: 'center' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: "-44px" }}>
            <div style={{
              ...
              background: photo ? "transparent" : "#475569",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
            }}>
        ...
        <div style={{ 
          ...
          background: `linear-gradient(180deg, ${themeColor2} 0%, ${themeColor1} 100%)`,
          color: "#FFFFFF", 
          textAlign: "center" 
        }}>
          <p style={{ 
      ...
      {activePanel && (
        <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 20 }} onClick={() => setActivePanel(null)}>
          <div
            ...
            style={{ width: isMobile ? '100%' : 520, maxWidth: '100%', height: isMobile ? '100%' : 'auto', maxHeight: isMobile ? '100%' : '80%', background: themeColor1, borderRadius: isMobile ? 0 : 16, overflow: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,0.3)', position: 'relative' }}
          >
            ...
            <div style={{ padding: 16, background: themeColor1, overflowY: 'auto', height: isMobile ? 'calc(100% - 72px)' : 'auto' }}>

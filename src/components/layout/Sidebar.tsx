  ...
  return (
    <>
      ...
      <motion.div
        ...
        transition={{ duration: 0.3, ease: "easeInOut" }}
        className={`fixed left-0 top-0 h-screen flex flex-col justify-between bg-linear-to-b from-[#0072EE] via-[#0052CC] to-[#0072EE] border-r border-blue-800/30 shadow-2xl overflow-hidden ${
          isMobile ? 'z-40' : 'z-40'
        }`}
        style={{
          boxShadow: isMobile 
      ...
      >
          ...
          <div className={`flex items-center ${(isMobile || expanded) ? 'justify-between px-5' : 'justify-center px-2'} h-16 border-b border-white/20 mt-6`}>
            ...
            {!isMobile && (
              <button
                ...
                className="p-2.5 hover:bg-white/20 hover:text-white rounded-lg transition-all duration-200 shadow-sm hover:shadow-md text-white/90"
              >
                <motion.div
                ...
                >
                  <Link href={item.path}>
                    <motion.div
                      ...
                      whileTap={{ scale: 0.97 }}
                      className={`flex items-center ${(isMobile || expanded) ? 'gap-5 px-6' : 'justify-center px-2'} py-4 rounded-lg cursor-pointer transition-all duration-300 ${
                        isActive
        ...
        <div className="mb-8 px-2">
          {/* Divider */}
          <div className="border-t border-white/30 mb-6 mx-2"></div>
          ...
          <p className="opacity-0 select-none text-sm mt-4">Spacer</p>
        </div>
      </motion.div>
    </>
  );
